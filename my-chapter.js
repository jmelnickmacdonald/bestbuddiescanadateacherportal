...
(() => {
  ...
  function setTask(
    task,
    completed,
    program = profile()?.program || "elementary"
  ) {
  ...
  function saveMeetingPlan(plan) {
    ...
    const normalized = {
      ...
      activityIds: Array.isArray(plan.activityIds)
        ? plan.activityIds
        : [],
      activityTitles: Array.isArray(plan.activityTitles)
        ? plan.activityTitles
        : [],
  ...
  function navLink() {
    ...
    return `
      <a
        class="bb-my-chapter-nav ${signed ? "is-signed-in" : ""}"
        href="my-chapter.html"
      >
  ...
  function ensureNavLink() {
    ...
    document
      .querySelectorAll(".site-menu-panel")
      .forEach(menu => {
        if (
          menu.querySelector(
            ".bb-my-chapter-menu-link"
          )
        ) {
          return;
        }
        ...
        menu.insertAdjacentHTML(
          ...
          `
            <a
              class="bb-my-chapter-menu-link"
              href="my-chapter.html"
            >
              ${
                signed
                  ? "My Chapter"
                  : "Sign in to My Chapter"
              }
            </a>
          `
        );
  ...
  function slotMarkup(slot) {
    ...
    const variant =
      slot.dataset.myChapterSlot ||
      "compact";

    const user = profile();

    const progress =
      taskProgress(user?.program);
        ...
        return `
          <div class="bb-personal-card bb-personal-card-home">
            ...
            <div>
              ...
              <span class="bb-personal-kicker">
                My Chapter
              </span>

              <strong>
                Want the Hub to remember where you are?
              </strong>

              <p>
                Track chapter progress, saved plans,
                check-ins, and your Buddy Bank.
              </p>
        ...
        return `
          <div class="bb-personal-card bb-personal-card-program">
            ...
            <div>
              ...
              <p>
                The Hub still works without signing in.
                Sign in if you want it to remember your
                chapter and where you left off.
              </p>
      ...
      if (variant === "builder") {
        return `
          <div class="bb-personal-inline">
            ...
            <span>
              <strong>
                Want to save your meeting plans?
              </strong>

              Sign in to My Chapter and this builder
    ...
    if (
      ...
      return `
        <a
          class="bb-personal-card bb-personal-card-signed"
          href="my-chapter.html"
        >
    ...
    return `
      <a
        class="bb-personal-compact is-signed-in"
        href="my-chapter.html"
      >
        My Chapter ·
        ${escapeHTML(progressText)} →
